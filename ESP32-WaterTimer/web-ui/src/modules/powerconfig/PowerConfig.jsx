                        ...
                        <Card.Body>
                            ...
                            <Form.Row>
                                <Form.Group as={Col} xs={12} md={6}>
                                    ...
                                    <Form.Text muted>
                                        Screen is turned off after this time.
                                    </Form.Text>
                                </Form.Group>
                            </Form.Row>
                        </Card.Body>
                        ...
                        <Card.Body>
                            ...
                            <Form.Row>
                                <Form.Group as={Col} xs={12} md={6}>
                                    ...
                                    <Form.Text muted>
                                        This is the minimum battery voltage to run this power mode.
                                    </Form.Text>
                                </Form.Group>
                                <Form.Group as={Col} xs={12} md={6}>
                        ...
                        <Card.Body>
                            ...
                            <Form.Row>
                                <Form.Group as={Col} xs={12} md={6}>
                                    ...
                                    <Form.Text muted>
                                        Amout of hours to deep sleep, until voltage comes back up to the minimum threshold of te lowe power mode
                                    </Form.Text>
                                </Form.Group>
                            </Form.Row>
                        </Card.Body>
